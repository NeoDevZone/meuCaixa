...
export function Home() {
  ...
  const [isSummaryModalOpen, setIsSummaryModalOpen] = useState(false); // Novo estado para o modal
            ...
            <div className="flex justify-center items-center gap-4 sm:gap-9 absolute -top-11.5 sm:-top-60 left-0 right-0 flex-col">
              <div className="flex justify-center sm:justify-end pr-0 sm:pr-5">
                <input
                  ...
                  className="h-11 w-50 px-4 rounded-2xl border-2 bg-border-detail border-text-dark text-text-dark font-semibold hover:cursor-pointer"
                />
              </div>
